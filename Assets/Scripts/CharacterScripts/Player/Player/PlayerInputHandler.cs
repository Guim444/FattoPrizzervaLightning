...
public class PlayerInputHandler : MonoBehaviour, Actions.IPlayerActions
{
    ...
    void Awake()
    {
        ...
        _punchAction = playerMap.FindAction("Punch", throwIfNotFound: false);
        _actionAction = playerMap.FindAction("Action", throwIfNotFound: false);
        ...
        {
            Debug.LogWarning(
                "PlayerInputHandler: no se encontró la acción 'Punch' en el mapa 'Player' de Actions.inputactions.");
        }
        ...
        {
            Debug.LogWarning(
                "PlayerInputHandler: no se encontró la acción 'Action' en el mapa 'Player' de Actions.inputactions.");
        }
    }
    ...
    private void OnPunchStarted(InputAction.CallbackContext _)
    {
